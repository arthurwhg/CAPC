###
# This utility is designed to transcrbe an audio and create a correction batch tasks file using chat completion API
# - transcribe
# - create chat completion tasks
#
# v1.0
#
###
...
model = whisper.load_model("small")   #"small", "medium", "large" available
